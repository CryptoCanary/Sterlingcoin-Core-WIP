...
// Copyright (c) 2018-2019 The Sterlingcoin developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"wallet", "pubkeytoaddress", &pubkeytoaddress, true, false, true},
        ...
        {"zerocoin", "getzslgseed", &getzslgseed, false, false, true},
        {"zerocoin", "setzslgseed", &setzslgseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzslg", &searchdzslg, false, false, true},
        {"zerocoin", "dzslgstate", &dzslgstate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19127/\n";
}
