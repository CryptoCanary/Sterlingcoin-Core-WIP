...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"To use heliumd, or the -server option to helium-qt, you must set an rpcpassword "
...
QT_TRANSLATE_NOOP("bitcoin-core", "Copyright (C) %i The Sterlingcoin Core Developers"),
