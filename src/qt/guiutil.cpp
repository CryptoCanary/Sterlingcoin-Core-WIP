...
#define URI_SCHEME "sterlingcoin"
...
{
    // return if URI is not valid or is no Sterlingcoin: URI
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient* out)
{
    ...
    //
    //    Cannot handle this later, because strlingcoin:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open slg.conf with the associated application */
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a sterlingcoin.desktop file to the autostart directory:
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the sterlingcoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add sterlingcoin app to startup item list
