...
{
    std::string genesisblockhash = "0000033346b0b31697bcd178789fe1d6d10f96a7fd46d74fbf647d5ea3757348";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (slg.conf).");
...
{
    QString CSS = "body {font-size:12px; color:#5A6876; bgcolor:#B2B2B2;}\n a, span { font-family: monospace; }\n span.addr {color:#B2B2B2; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #B2B2B2;}\n td.d0 {font-weight: bold; color:#5A6876;}\n h2, h3 { white-space:nowrap; color:#5A6876;}\n a { color:#8A8A8A; text-decoration:none; }\n a.nav {color:#5A6876;}\n";
