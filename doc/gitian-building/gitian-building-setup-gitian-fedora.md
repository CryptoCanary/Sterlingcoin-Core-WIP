...
Clone the git repositories for Sterlingcoin Core and Gitian.
...
git clone https://github.comSterlingcoin/Sterlingcoin-Core/contrib/Sterlingcoin-detached-sigs.git
```
