...
In order to support loading of multiple wallets in Sterlingcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoind.cpp.

Finally, two new headers and source files will have to be added to sterloingcoin-qt.pro.
